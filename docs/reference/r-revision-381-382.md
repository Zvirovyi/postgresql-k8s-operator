...
* Added support for tracing with `tempo_k8s` ([PR #497](https://github.com/canonical/postgresql-k8s-operator/pull/497)) ([DPE-4617](https://warthogs.atlassian.net/browse/DPE-4617))
...
* More logs from pgbackrest create backup command ([PR #587](https://github.com/canonical/postgresql-k8s-operator/pull/587))
